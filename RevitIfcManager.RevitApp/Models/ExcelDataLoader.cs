...
namespace RevitIfcManager.Models
{
    public static class ExcelDataLoader
    {
        ...
        public static string LoadExistingOrPrompt()
        {
            ...
            if (string.IsNullOrEmpty(excelFilePath) || !File.Exists(excelFilePath))
            {
                ...
                excelFilePath = System.IO.Path.Combine(assemblyFolder, "Files", "RevitIfcManager", "IFC parameters.xlsx");
